...
<html>
	...
	<body>
		...
		<div class="right_data list-group">
			<div class="monitoringDate_box"><select id="monitoringDate" class="form-control"></select></div>
			<div id="monitoringType" class="panel-heading">
				<label class="radio-inline">
				  	<input type="radio" name="monitoringType" value="option1" checked="checked">两期监测图斑总面积/个数的对比
				</label>
				<label class="radio-inline">
				  	<input type="radio" name="monitoringType" value="option2">两期各城市用地面积的增幅
				</label>
				<label class="radio-inline">
				  	<input type="radio" name="monitoringType" value="option3">两期各地类增减幅情况
				</label>
				<label class="radio-inline">
				  	<input type="radio" name="monitoringType" value="option4">两期各性质增减幅情况
				</label>
			</div>
	   		<div class="list-group-item top_data">
	   			<div id="chart" class="chart"></div>
	   		</div>
	   		<div class="list-group-item bottom_data">
